...
const About = () => {
    return (
        <div className="bg-[#131931]">
            <section>
                <div className="py-24 px-6 md:px-0 md:w-10/12 mx-auto">
                    <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
                        <div className="mx-auto max-w-lg text-left lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
                            ...
                            <Button
                                className="block w-full rounded bg-[#05B804] px-12 py-3 text-sm font-medium text-white shadow hover:bg-[#05B804] focus:outline-none focus:ring active:bg-[#056B53] mt-5 sm:w-auto "
                                href="#"
                            >
                                Get Started
                            </Button>
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
                            <a
                                ...
                                href="#"
                            >
                                <span className="inline-block rounded-lg bg-[#05B804] text-white p-3">
                                    <svg
                                        className="size-6"
                                        fill="none"
                                        stroke="currentColor"
                                ...
                                <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-[#f2f2f2]">
